    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        if ("/consultants".equals(path)) {
            ...
            resp.getWriter().write(
                    ...
                    "        labels: labels,\n" +
                    "        datasets: [\n" +
                    "          { label: 'Raw Glucose', data: rawData, borderColor: 'rgba(255,160,160)', borderWidth: 3, fill: false, order: 2 },\n" +
                    "          { label: 'Smoothed Glucose', data: smoothData, borderColor: 'rgb(142,11,11)', borderWidth: 1, fill: false, order: 1 }\n"+
                    "        ]\n" +
                    "      },\n" +
                    "      options: {\n" +
                    "        responsive: true,\n" +
